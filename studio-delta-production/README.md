...
- `/users` — office and floor people, Railway backup download. Google Sheets is not used. On Admin people, tick **Costing**, **Quoting**, and **Approval** so those names fill in automatically on new enquiries. You can still pick someone else on a single enquiry. Leave Approval unticked to skip cost-sheet approval.
