...
- `/outlook-addin` — install the Outlook button. Open an email in Outlook, click **Studio Delta**, pick the enquiry. **Open in Outlook** on the enquiry launches Outlook desktop. No `.msg` files are uploaded or downloaded.
