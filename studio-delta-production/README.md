...
Office sidebar → **Planning** is the live person calendars: every worker, one week at a time, work days only, hours from Task times. See `/planning` above.
