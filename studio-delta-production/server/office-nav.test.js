...
assert.ok(js.indexOf("another person’s name") !== -1 || js.indexOf("another person's name") !== -1);
...
assert.ok(processJs.indexOf("Paste any link") !== -1);
...
assert.ok(processJs.indexOf("saved on the server as Correspondance link") !== -1);
...
assert.ok(enquiriesHtml.indexOf("/enquiry-process.js?v=access-lock") !== -1);
...
assert.ok(usersHtml.indexOf("someone else’s access code") !== -1 || usersHtml.indexOf("someone else's access code") !== -1);
