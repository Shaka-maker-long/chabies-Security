...
assert.ok(enquiriesHtml.indexOf("data-delete-enquiry") !== -1, "enquiry sheet can delete a row");
...
assert.ok(enquiriesHtml.indexOf("This cannot be undone") !== -1);
assert.ok(processJs.indexOf("sdConfirmDelete") !== -1);
assert.ok(processJs.indexOf("data-delete-file") !== -1, "files list can delete an attachment");
