...
assert.ok(planningHtml.indexOf('data-kind-filter="plan"') !== -1 && planningHtml.indexOf(">Planned<") !== -1, "Journey can filter to Planned rows");
assert.ok(planningHtml.indexOf('data-kind-filter="actual"') !== -1 && planningHtml.indexOf(">Actual<") !== -1, "Journey can filter to Actual rows");
