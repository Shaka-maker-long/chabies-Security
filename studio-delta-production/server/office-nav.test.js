...
assert.ok(js.indexOf("Consumables") === -1, "consumables is an Orders subpage");
...
assert.ok(ordersHtml.indexOf("/orders/consumables") !== -1);
assert.ok(ordersHtml.indexOf("Consumables") !== -1);
assert.ok(indexJs.indexOf("/orders/consumables") !== -1);
...
const consumablesHtml = fs.readFileSync(path.join(__dirname, "../public/orders-consumables.html"), "utf8");
assert.ok(consumablesHtml.indexOf("Current stock") !== -1);
assert.ok(consumablesHtml.indexOf("Minimum") !== -1);
assert.ok(consumablesHtml.indexOf("Log usage") !== -1);
assert.ok(consumablesHtml.indexOf("Create purchase") !== -1);
assert.ok(consumablesHtml.indexOf("Receive purchase") !== -1);
assert.ok(consumablesHtml.indexOf("Usage and receive log") !== -1);
assert.ok(consumablesHtml.indexOf("sdRequireOffice(\"orders\")") !== -1);
assert.ok(consumablesHtml.indexOf("Steel stock") === -1);
assert.ok(consumablesHtml.indexOf("Glass stock") === -1);
assert.ok(consumablesHtml.indexOf("Wood stock") === -1);
assert.ok(consumablesHtml.indexOf("Hinges, bullets, screws") !== -1);
