...
assert.ok(floor.indexOf("road-atlas") !== -1);
assert.ok(floor.indexOf("road-asphalt") !== -1);
assert.ok(floor.indexOf("road-rail") !== -1);
assert.ok(floor.indexOf("road-roller") !== -1);
assert.ok(floor.indexOf("road-dest") !== -1);
assert.ok(floor.indexOf("Pre-Powder Coating QC") !== -1);
assert.ok(floor.indexOf("Final QC") !== -1);
assert.ok(floor.indexOf("road-station") !== -1);
assert.ok(floor.indexOf("road-station-legs") !== -1);
assert.ok(floor.indexOf("New orders") !== -1);
assert.ok(floor.indexOf("Straight to assembly") !== -1);
assert.ok(floor.indexOf("bi-geo") === -1, "workstations replace map pins");
assert.ok(floor.indexOf("stroke-width: 14") === -1, "belt must stay thinner than the old asphalt road");
assert.ok(floor.indexOf("QC_PHASE_GROUPS") !== -1);
