...
assert.ok(usersHtml.indexOf("Download JSON") !== -1);
assert.ok(usersHtml.indexOf("Download SQLite") !== -1);
assert.ok(usersHtml.indexOf("Backup now") !== -1);
assert.ok(usersHtml.indexOf("Download complete backup") !== -1);
assert.ok(usersHtml.indexOf("Type RESTORE") !== -1);
assert.ok(usersHtml.indexOf("/api/office/backups/run") !== -1);
assert.ok(usersHtml.indexOf("backup.db") !== -1);
assert.ok(usersHtml.indexOf("backup.tgz") !== -1);
assert.ok(usersHtml.indexOf("backups/restore") !== -1);
