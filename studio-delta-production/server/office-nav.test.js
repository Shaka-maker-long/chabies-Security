...
assert.ok(planningHtml.indexOf("This week's orders") !== -1);
assert.ok(planningHtml.indexOf("Start date") !== -1 && planningHtml.indexOf("End date") !== -1, "Journey list must show start date and end date");
