...
assert.ok(ordersHtml.indexOf("id=\"pasteBox\"") !== -1);
assert.ok(ordersHtml.indexOf("id=\"pasteText\"") !== -1);
assert.ok(ordersHtml.indexOf("Paste from the old sheet") !== -1);
assert.ok(ordersHtml.indexOf("Everyone has paid in full") !== -1);
