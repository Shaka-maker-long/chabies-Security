...
assert.ok(costHtml.indexOf("Glass actual") !== -1);
assert.ok(costHtml.indexOf("Powder actual") !== -1);
assert.ok(costHtml.indexOf("wood and backboard") !== -1);
assert.ok(costHtml.indexOf("o.materialCost") !== -1);
assert.ok(costHtml.indexOf("o.glassCost") !== -1);
assert.ok(costHtml.indexOf("o.powderCost") !== -1);
