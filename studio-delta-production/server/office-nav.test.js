...
assert.ok(inventoryHtml.indexOf(">ROP<") !== -1);
assert.ok(inventoryHtml.indexOf("Unit price") !== -1);
assert.ok(inventoryHtml.indexOf("Log usage") !== -1);
assert.ok(inventoryHtml.indexOf("Create purchase") !== -1);
assert.ok(inventoryHtml.indexOf("Receive purchase") !== -1);
assert.ok(inventoryHtml.indexOf("Usage and receive log") !== -1);
