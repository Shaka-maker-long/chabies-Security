(function () {
  ...
  function filesCard(row) {
    ...
    let html = "<div class=\"sd-files sd-correspondence\"><h2>Files</h2>" +
      "<p class=\"sd-process-sub\">Add another Correspondance link, upload another cost sheet or drawing, or issue another quote from the forms on this sheet. Uploading the same kind of file again replaces that file. Files stay on the enquiry.</p>";
    if (!items.length) {
